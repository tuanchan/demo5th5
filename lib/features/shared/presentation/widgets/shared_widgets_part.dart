  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Icon(widget.icon, color: AppColors.onIconButton, size: 24),
      ),
    );
  }
}
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          ...
          children: [
            Icon(widget.icon, color: AppColors.onSolidButton, size: 24),
            SizedBox(width: 10),
            Text(
              widget.text,
              style: TextStyle(
            ...
            children: items.map((item) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: selected ? AppColors.yellow : AppColors.inputFill,
                    borderRadius: BorderRadius.circular(12),
                  ...
                  child: Text(
                    item.label,
                    style: TextStyle(
                      color: selected ? AppColors.onAccentButton : AppColors.text,
                      fontSize: 14,
                      fontWeight: FontWeight.w900,
                    ),
                  ),
